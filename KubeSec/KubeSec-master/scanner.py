...
def isValidUserName(uName): 
    logging.info(f"[ENTRY] isValidUserName called with input: {repr(uName)}")
    valid = True
    if (isinstance( uName , str)  ): 
        ...
        valid = False        
    logging.info(f"[EXIT] isValidUserName returning: {valid}")
    return valid

def isValidPasswordName(pName): 
    logging.info(f"[ENTRY] isValidPasswordName called with input: {repr(pName)}")
    valid = True
    if (isinstance( pName , str)  ): 
        ...
        valid = False  
    logging.info(f"[EXIT] isValidPasswordName returning: {valid}")             
    return valid
